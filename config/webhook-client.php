...
return [
    'configs' => [
        [
             ...
             */
            'signing_secret' => env('TELEGRAM_WEBHOOK_CLIENT_SECRET', ''),
             ...
             */
            'signature_validator' => \App\Http\Webhooks\Telegram\SignatureValidator::class,
             ...
             */
            'process_webhook_job' => \App\Jobs\ProcessTelegramBotWebhook::class,
        ],
    ],
];
